							...
							<div class="messages-list">
								<div class="message-item dm-message">
									...
									<div class="message-content">
										...
										<div class="message-text">
											Bem-vindos à Floresta Sombria. Vocês se encontram em uma clareira, os sons de
											criaturas misteriosas ecoam ao seu redor...
										</div>
								...
								<div class="message-item dm-message">
									...
									<div class="message-content">
										<div class="message-sender">Mestre</div>
										<div class="message-text">
											Gorn, você nota rastros recentes de humanoides pequenos se movendo para o
											leste. Lyra, você detecta uma aura fraca de transmutação vindo de uma árvore
											antiga ao norte.
										</div>
								...
								<div class="message-item">
									...
									<div class="message-content">
										...
										<div class="message-text">
											Eu vou na frente para verificar armadilhas. Provavelmente não é uma árvore
											comum.
										</div>
										<div class="message-roll success">
								...
								<div class="message-item dm-message">
									...
									<div class="message-content">
										<div class="message-sender">Mestre</div>
										<div class="message-text">
											Vex, você se aproxima com cautela e percebe que um pequeno compartimento está
											escondido no tronco da árvore. Parece conter algo...
										</div>
